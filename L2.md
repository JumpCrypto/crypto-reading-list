...
* [Vitalik's post on rollups](https://vitalik.eth.limo/general/2021/01/05/rollup.html) - a fairly technical summary of the SOTW of rollups
...
* [Eth docs on zk-rollups](https://ethereum.org/en/developers/docs/scaling/zk-rollups/)
